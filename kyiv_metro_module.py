...
ГЕОМЕТРІЯ СТАНЦІЙ МЕТРО (STATION LAT/LNG) — ЗВІДКИ ВОНА ТУТ:
  ...
  ЯК ЩЕ ПОКРАЩИТИ: заміни METRO_LINES[key]["pts"] нижче на реальні дані
  з ресурсу "underground"/"stopsUnderground" (якщо колись знайдеться) —
  решта коду (build_metro_feed) не зміниться.
